...
folder_name = "./Modified_Images/"   # or specify your absolute path
if not os.path.exists(folder_name):
   os.makedirs(folder_name)


image_url = '/Train/Jamie_Before.jpg'
# image_url = '/Test/Before.png'
...
sunglasses = cv2.imread('/Train/glasses.png', cv2.IMREAD_UNCHANGED)
for (x, y, w, h) in eyes:
